...
{
    public class CDMSupplier : CDataModule, IDataModuleSimple
    {
        public CSupplierModel Model { get { return (CSupplierModel)this.model; } }

        public CDMSupplier() : base() {
            this.model = new CSupplierModel(false);
        }
